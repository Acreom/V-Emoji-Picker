...
var __vue_staticRenderFns__$3 = [];
  ...
  const __vue_inject_styles__$3 = function (inject) {
    if (!inject) return
    inject("data-v-c5a3de34_0", { source: ".category-title[data-v-c5a3de34]{text-transform:uppercase;font-size:.8em;padding:5px 0 0 2px;color:#676666}.category-title[data-v-c5a3de34]:not(:first-of-type){padding:10px 0 0 2px}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$3 = "data-v-c5a3de34";
  /* module identifier */
...
var __vue_staticRenderFns__$4 = [];
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-3a2cdeeb_0", { source: "#Emojis[data-v-3a2cdeeb]{font-family:Twemoji,NotomojiColor,Notomoji,EmojiOne Color,Symbola,Noto,Segoe UI Emoji,OpenSansEmoji,monospace;display:block;width:100%;max-width:100%;color:var(--ep-color-text)}#Emojis[data-v-3a2cdeeb] ::-webkit-scrollbar{border-radius:4px;width:4px;overflow:hidden}.container-emoji[data-v-3a2cdeeb]{overflow-x:hidden;overflow-y:scroll;height:220px}.grid-emojis[data-v-3a2cdeeb]{display:grid;margin:5px 0;justify-items:center}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$4 = "data-v-3a2cdeeb";
  /* module identifier */
...
var __vue_staticRenderFns__$5 = [];
  ...
  const __vue_component__$5 = /*#__PURE__*/normalizeComponent(
    ...
    VEmojiPicker.prototype.onMounted = function () {
    };
    ...
    VEmojiPicker.prototype.mounted = function () {
        this.onMounted();
    };
    __decorate([
    ...
    __decorate([
        vuePropertyDecorator.Emit("ready")
    ], VEmojiPicker.prototype, "onMounted", null);
    __decorate([
...
var __vue_staticRenderFns__$6 = [];
  ...
  const __vue_inject_styles__$6 = function (inject) {
    if (!inject) return
    inject("data-v-5463b9f5_0", { source: ".emoji-picker[data-v-5463b9f5]{--ep-color-bg:#f0f0f0;--ep-color-sbg:#f6f6f6;--ep-color-border:#3e4856;--ep-color-text:#4a4a4a;--ep-color-active:#64D7DE;display:inline-flex;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeSpeed;flex-direction:column;align-items:center;background:0 0;border-radius:4px;border:none;overflow:hidden;width:250px;user-select:none}.dark[data-v-5463b9f5]{--ep-color-bg:#f0f0f0;--ep-color-sbg:#f6f6f6;--ep-color-border:#3e4856;--ep-color-text:#4a4a4a;--ep-color-active:#64D7DE}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$6 = "data-v-5463b9f5";
  /* module identifier */
