...
var __vue_staticRenderFns__$6 = [];
  ...
  const __vue_inject_styles__$6 = function (inject) {
    if (!inject) return
    inject("data-v-67964498_0", { source: ".emoji-picker[data-v-67964498]{--ep-color-bg:#f0f0f0;--ep-color-sbg:#f6f6f6;--ep-color-border:#3e4856;--ep-color-text:#4a4a4a;--ep-color-active:#64D7DE;display:inline-flex;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeSpeed;flex-direction:column;align-items:center;background:0 0;border-radius:4px;border:none;overflow:hidden;width:250px;user-select:none}.dark[data-v-67964498]{--ep-color-bg:#f0f0f0;--ep-color-sbg:#f6f6f6;--ep-color-border:#3e4856;--ep-color-text:#4a4a4a;--ep-color-active:#64D7DE}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$6 = "data-v-67964498";
  /* module identifier */
