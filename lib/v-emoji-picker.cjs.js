...
var InputSearch = /** @class */ (function (_super) {
    ...
    InputSearch.prototype.mounted = function () {
        var _this = this;
        if (this.focusOnOpen) {
    ...
    __decorate([
        vuePropertyDecorator.Prop({ required: true })
    ], InputSearch.prototype, "focusOnOpen", void 0);
    __decorate([
...
var __vue_staticRenderFns__$5 = [];
  ...
  const __vue_component__$5 = /*#__PURE__*/normalizeComponent(
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: true })
    ], VEmojiPicker.prototype, "focusSearchOnOpen", void 0);
    __decorate([
...
/* template */
var __vue_render__$6 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:['emoji-picker', {dark: _vm.dark}],attrs:{"id":"EmojiPicker"}},[(_vm.showCategories)?_c('Categories',{attrs:{"categories":_vm.categoriesFiltered,"current":_vm.currentCategory},on:{"select":_vm.changeCategory}}):_vm._e(),_vm._v(" "),(_vm.showSearch)?_c('InputSearch',{attrs:{"focus-on-open":_vm.focusSearchOnOpen},on:{"update":_vm.onSearch}}):_vm._e(),_vm._v(" "),_c('EmojiList',{attrs:{"data":_vm.mapEmojis,"category":_vm.currentCategory,"filter":_vm.filterEmoji,"emojiWithBorder":_vm.emojiWithBorder,"emojiSize":_vm.emojiSize,"emojisByRow":_vm.emojisByRow,"hasSearch":_vm.showSearch},on:{"select":_vm.onSelectEmoji}})],1)};
var __vue_staticRenderFns__$6 = [];

  /* style */
  const __vue_inject_styles__$6 = function (inject) {
    if (!inject) return
    inject("data-v-5956f762_0", { source: ".emoji-picker[data-v-5956f762]{--ep-color-bg:#f0f0f0;--ep-color-sbg:#f6f6f6;--ep-color-border:#3e4856;--ep-color-text:#4a4a4a;--ep-color-active:#64D7DE;display:inline-flex;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeSpeed;flex-direction:column;align-items:center;background:0 0;border-radius:4px;border:none;overflow:hidden;width:250px;user-select:none}.dark[data-v-5956f762]{--ep-color-bg:#f0f0f0;--ep-color-sbg:#f6f6f6;--ep-color-border:#3e4856;--ep-color-text:#4a4a4a;--ep-color-active:#64D7DE}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$6 = "data-v-5956f762";
  /* module identifier */
